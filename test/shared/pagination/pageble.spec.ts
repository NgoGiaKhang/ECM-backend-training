...
describe("Pageable", () => {
  describe("constructor", () => {
    it("should create pageable with provided values", () => {
      ...
      const pageable = new Pageable(2, 20, sort);
    ...
    it("should throw when page is Infinity", () => {
      expect(() => {
        new Pageable(Number.POSITIVE_INFINITY, 10);
      }).toThrow("Page must be a positive integer");
    });

    it("should throw when limit is Infinity", () => {
      expect(() => {
        new Pageable(1, Number.POSITIVE_INFINITY);
      }).toThrow("Limit must be a positive integer");
    });
  });
  ...
  describe("skip", () => {
    it("should calculate skip correctly", () => {
      const pageable = new Pageable(3, 10);
    ...
    it("should calculate skip with custom limit", () => {
      const pageable = new Pageable(5, 25);
  ...
  describe("take", () => {
    it("should return limit value", () => {
      const pageable = new Pageable(1, 50);
  ...
  describe("withPage", () => {
    it("should return new pageable with updated page", () => {
      ...
      expect(result.sort).toBe(pageable.sort);
    });
  ...
  describe("withSize", () => {
    it("should return new pageable with updated limit", () => {
      const pageable = new Pageable(5, 10);
    ...
    it("should preserve sort configuration", () => {
      ...
      const pageable = new Pageable(1, 10, sort);
  ...
  describe("withSort", () => {
    it("should return new pageable with updated sort", () => {
      ...
      const result = pageable.withSort(sort);
  ...
  describe("toParams", () => {
    it("should convert pageable to params object", () => {
      const pageable = new Pageable(2, 20, Sort.from("-name"));

      expect(pageable.toParams()).toEqual({
        page: 2,
        size: 20,
        sort: "-name",
      });
  ...
  describe("from", () => {
    it("should create pageable from raw values", () => {
      const pageable = Pageable.from("2", "25", "-name");
    ...
    it("should parse sort correctly", () => {
      const pageable = Pageable.from(1, 10, "-createdAt,name");
  ...
  describe("of", () => {
    it("should create pageable instance", () => {
      ...
      const pageable = Pageable.of(3, 15, sort);
  ...
  describe("immutability", () => {
    ...
    it("should not mutate original instance when changing sort", () => {
      ...
      pageable.withSort(Sort.from("-name"));
